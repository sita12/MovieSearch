class ReviewsController < ApplicationController
  ...
  def create
    @movie = Moviee.find_or_initialize_by(tmdb_id: params[:tmdb_id])
    ...
    @review = current_user.reviews.new(review_params.merge(moviee_id: @movie.id))
  ...
  def review_params
    params.require(:review).permit(:coment)
  end
end
